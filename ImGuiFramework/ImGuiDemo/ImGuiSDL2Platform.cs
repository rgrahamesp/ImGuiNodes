namespace ImGuiFramework.ImGuiDemo
{
    ...
    public static class ImGuiSDL2Platform
    {
        ...
        {
            string url = Utils.ToStringFromUTF8(path)!;
        ...
        public static unsafe bool Init(Window* window, Renderer* renderer, void* sdlGLContext)
        {
            ...
            BackendData* bd = Utils.AllocT<BackendData>();
            Utils.ZeroMemoryT(bd);
            ...
            bd->MouseCursors = (Cursor**)Utils.AllocArray((uint)ImGuiMouseCursor.Count);
        ...
        {
            BackendData* bd = GetBackendData();
            ViewportData* vd = Utils.AllocT<ViewportData>();
            Utils.ZeroMemoryT(vd);
